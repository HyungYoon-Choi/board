   ...
   <div class="container">
             ...
             <nav class="top-nav">
             	<c:choose>
             		<c:when test="${ sessionScope.level == 0 || empty sessionScope.level}">
                		...
                		<a href="?fname=member/myReg">회원가입</a> |
                	</c:when>
                	<c:otherwise>
               			<a href="/board/logOut">로그아웃</a> |
                		<a href="?fname=member/edtregister">회원수정</a>
                	</c:otherwise>
                </c:choose>
       ...
       <div class="row">
           <nav class="navi pb-3 text-center">
               <a href="?fname=member/notice">공지사항</a>
               <a href="?fname=member/gallery">갤러리</a>
               <a href="?fname=member/column">컬럼게시판</a>
               <a href="?fname=member/freelist">자유게시판</a>
           </nav>
       </div>
   </div>
</header>